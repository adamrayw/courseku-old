...
<body>
    ...
    <div class="wrapper max-w-6xl mx-auto px-2 md:px-0 ">
        <section class="all-course mt-6 px-2 text-center h-screen">
            <div class="all-course-head text-left mb-8">
                <h1 class="font-semibold text-2xl md:text-4xl mb-2">Kebijakan Privasi</h1>
                <hr>
                <p class="mt-4 text-lg text-gray-500">Kebijakan Privasi bertujuan untuk memberikan informasi kepada Anda bagaimana cara kami mengumpulkan, memelihara, mengelola, dan menghapus informasi pribadi Anda. Maka dengan ini kami harapkan informasi yang kami terima dari Anda dapat bermanfaat bagi layanan kami dalam pengembangan kedepannya.</p>
            </div>
            <div class="all-course-head text-left">
                <h1 class="font-normal text-xl md:text-4xl mb-2">Keamanan Informasi Pribadi</h1>
                <p class="mt-4 text-lg text-gray-500">Kami sangat paham bahwa melindungi informasi dan memberikan kontrol kepada Anda adalah tanggung jawab yang besar, maka dengan itu kami berusaha agar informasi Anda tidak bocor dan di salah gunakan orang lain.</p>
            </div>
